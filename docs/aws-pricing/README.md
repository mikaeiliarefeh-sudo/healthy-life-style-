...
| `aws_pricing_us-east-1.csv` | همه‌ی ۸٬۸۸۰ ردیف، تخت (`product, service, dimension, name, spec, unit, price, note`) |
...
| پشتیبانی | Developer / Business / Enterprise — درصد پلکانی از کل صورتحساب + کف ثابت ماهانه |
